...
<div class="container mt-5 ">
	<h4 class="mt-5 pt-5 "style="color:#10C4BE;">Compétences</h4><br>
	
		<form  action="traitement-competences.php" method="POST" class="h-100 d-block">
        ...
        <strong><label style="color: #FFBF00;">Bureautique</label></strong>
			...
			<div class="col custom-control custom-checkbox">
  				<input type="checkbox" class="custom-control-input" name="bureau[]" value="Power Point" id="customCheck3">
			...
			<div class="col-md-3">
				...
				<div class=" col custom-control custom-checkbox">
  				<input type="checkbox" class="custom-control-input" name="info[]" value="Pascal" id="customCheck9">
  				<label class="custom-control-label" for="customCheck9">Pascal</label>
				</div>
				<div class=" col custom-control custom-checkbox">
  				<input type="checkbox" class="custom-control-input" name="info[]" value="Python" id="customCheck10">
  				<label class="custom-control-label" for="customCheck10">Python</label>
				</div>
...
<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Arabe" id="customCheck14">
  <label class="custom-control-label" for="customCheck14">Arabe</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Francais" id="customCheck15">
  <label class="custom-control-label" for="customCheck15">Français</label>
</div>   

<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Anglais" id="customCheck16">
  <label class="custom-control-label" for="customCheck16">Anglais</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Espagnol" id="customCheck17">
  <label class="custom-control-label" for="customCheck17">Espagnol</label>
</div>

<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Allemand" id="customCheck18">
  <label class="custom-control-label" for="customCheck18">Allemand</label>
</div>
<div class="custom-control custom-checkbox">
  <input type="checkbox" class="custom-control-input" name="langue[]" value="Mandarin" id="customCheck19">
  <label class="custom-control-label" for="customCheck19">Mandarin</label>
</div>
</div>
    </div>

   <div class="d-flex flex-row justify-content-end"><button  type="submit" class="btn btn-secondary btn-md  mt-5 ml-5" name="suivant" >Suivant</button>
</div>
		</form></div>
