...
<div class="col-md-2 mt-5" style=" position: fixed; ">
  <img src="photos/ensaklogo.png" class="mt-2" style="width: 90%;"><br><br>
...
<h3 class="pt-5 mt-5 ml-5 pl-4" style="text-align: center;">Offres pour lesquelles vous avez postulé</h3>
<section class="col-md-12 row">
<div class="col-md-2"></div>
<div class="col-md-10 row d-flex justify-content-center p-4">
<?php
include("connexion.php");
$sql1="SELECT id6 from postuler where apogee='".$apogee."'";
$r1=mysqli_query($link,$sql1);
while($d1=mysqli_fetch_assoc($r1)){
$id6=$d1['id6'];
$sql2="SELECT * from offre where id6='".$id6."'";
...
<div class="card m-3" style="width: 10rem;">
  <img src="photos/postuler.jpg" class="card-img-top">
  <div class="card-body">
...
if(mysqli_num_rows($r1)==0) { echo'
<img src="photos/recherche.gif" style="height:500px; width:700px;"><h4 class="col-md-8 offset-md-2 mb-5">Vous n\'avez postulé pour aucune offre</h4>';}
