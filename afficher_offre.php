...
<div class="col-md-3 offset-md-9 p-4 " style="overflow:auto; background-color: #717B83; position: fixed; top: 130px; color: white;">
  <h5 style="text-align: justify;" class="col-md-12">Voici les détails de l'offre que vous venez de créer. Tous les étudiants peuvent maintenant la visulaliser et y postuler.</h5>
</div>
</div>


<h3 class="pt-5 mt-5" style="text-align: center;"></h3>
<section class="d-flex flex-row justify-content-center mb-5">
...
<div class="col-md-9 d-flex flex-row justify-content-end mt-3" style="background-color: #1C797E; color: white; text-align: center;">
  <div class="col-md-8 mt-2 pb-3 pt-3">
   ...
   <h2 style="color: white;text-decoration: underline;" class="mt-5 "><?php 
...
<br><div style="margin-left:32%;">
 <form action="modifier_offre.php" method="post"><button type="submit" name="apo" class="btn btn-dark"  value=<?php echo $id_offre ;?> >Modifier</button></form>
  <form action="supprimer_offre.php" method="post"><button type="submit" name="poa" class="btn btn-dark" value="supprimer"> Supprimer</button></form>
 </div>
</div></div>
