...
$r3="SELECT position,organisme,date_debut,date_fin from expre_prof,avoir_exp where expre_prof.id5=avoir_exp.id5 and apogee='".$apogee."'";
...
<h3 class="pt-5 mt-4 col-md-7 offset-md-2" style="text-align: center;">Mon CV</h3>
<div class="row col-md-12">
<div class="col-md-2" style=" position: fixed; ">
  <img src="photos/ensaklogo.png" style="width: 90%;"><br><br>
  <p style="text-align: justify;" class="col-sm-12"> L'École Nationale des Sciences Appliquées de Kénitra est une grande école d’ingénieurs marocaine créée en 2008 par un partenariat entre l'Université Ibn-Tofail et l’Institut national des sciences appliquées de Lyon.</p></div>

  <section class="mb-5 offset-md-2 col-md-7">

<div>

<div class="col-md-12 d-flex flex-row justify-content-end mt-3 " style="background-color: #1C797E; color: white; text-align: center;">
  <div class="col-md-8 mt-2 pb-3 pt-3">

  <div style="position: relative; top: 30px;"><h3 style="color: white;"><?php $d1=mysqli_fetch_assoc($f1); echo $d1['nom'].' '.$d1['prenom'];?></h3>
  <h4 style="color: white;"><?php echo $d1['filiere'];?> </h4></div>
...
<div class="col-md-12 pt-3 pl-5 mb-5" style="background-color: #F6F5F4;">
  ...
  <br>
   ...
   <div class="row"> <img src="photos/diplome1.png" class="pr-2" style="width: 40px; height: 40px;"><h4 style="color: #10C4BE;" class="pt-2">Diplomes obtenus:</h4></div>
  <?php
 ...
 ?>
  ...
  <br>
   <div class="row"> <img src="photos/exp1.png" class="pr-2" style="width: 40px; height: 40px;"><h4 style="color: #10C4BE;" class="pt-2">Experience professionnelle:</h4></div>
  <?php
...
?> </h6>
  ...
  <br><div class="row"> <img src="photos/video1.png" class="pr-2 mb-3" style="width: 50px; height: 50px;"><h4 style="color: #10C4BE;" class="pt-2">Ma video:</h4></div>
  <video width="320" height="240" controls="controls" class="ml-5">
  <source src="video/<?php echo $apogee.'.mp4' ;?>" type="video/mp4"/>
  </video>
  <form action="modifier_cv.php" method="post" class="d-flex flex-row justify-content-end"><button type="submit" class="btn btn-dark mt-2 mb-2 mr-2" name="modifiercv">Modifier</button></form>
</div>

</div>
</section>
<div class="col-md-3 ">
  <h5 class="p-4" style="text-align: justify; background-color: #717B83;  color: white;  ">Votre CV sera visualisé de la part de toutes les entreprises de la plateform si vous satisfaisez l'une de leurs critères de recherche. De même, si vous postulez pour l'une des offres de stage disponibles.</h5> <br><h5 style="text-align: justify; background-color: #717B83;  color: white;" class="mt-2 p-4">Pour modifier les informations de votre CV, vous pouvez cliquer sur le boutton "Modifier" en bas. </h5></div>
</div>

<?php } else {
?>

<section class="col-md-12 d-flex flex-row justify-content-center">

<div class="col-md-6 m-5">
    <div class="card text-white bg-secondary">
      <img src="photos/cv.jpg" class="card-img-top">
      <div class="card-body">
        <h5 class="card-title">Votre CV est incomplet!</h5>
