...
<h3 class="pt-5 mt-5" style="text-align: center; position: relative; right: 50px;">Résultats des offres cherchées</h3>
...
$fil=$_GET['fil'];
$type=$_GET['type']; 
$sql2="SELECT * from offre where filiere='".$fil."' and type='".$type."'";
